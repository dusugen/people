...
function Filters(props) {
  ...
  const {
          name, setName, email, setEmail, setGender, activeStatus, setActiveStatus, inActiveStatus, setInActiveStatus
        } = props
  return (<div className="col-3 ms-5">
    ...
    <Button className={`d-block btn-danger btn-lg`} onClick={handleReset}>Reset</Button>
  </div>);
}
